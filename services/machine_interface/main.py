...
# old one working commented function
...
#         try:
#             rr1 = await client.read_holding_registers(address=BARCODE_FLAG_1, count=1,unit=1)
#             rr2 = await client.read_holding_registers(address=BARCODE_FLAG_2, count=1,unit=1)
